...
export function demoLookup(address: string): DistrictLookupResult {
  ...
  return {
    ...
    representatives: [
      ...
      {
        bioguideId: "ocd-person/demo-state-lower",
        personId: "ocd-person/demo-state-lower",
        fullName: "Demo State Representative",
        chamber: "state",
        stateLegislativeChamber: "lower",
        party: "Democrat",
        photoUrl: null,
        state,
        district: "12",
      ...
      {
        bioguideId: "ocd-person/demo-state-upper",
        personId: "ocd-person/demo-state-upper",
        fullName: "Demo State Senator",
        chamber: "state",
        stateLegislativeChamber: "upper",
        party: "Republican",
        photoUrl: null,
        state,
        district: "8",
    ...
    stateHouseDistrict: "12",
    stateSenateDistrict: "8",
